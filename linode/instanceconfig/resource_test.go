...
func TestAccResourceInstanceConfig_deviceBlockExtension(t *testing.T) {
	t.Parallel()
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: tmpl.DeviceBlockExt(t, instanceName, testRegion, rootPass),
				Check: resource.ComposeTestCheckFunc(
					checkExists(resName, nil),
					resource.TestCheckResourceAttr(resName, "label", "my-config"),
					devicesCheck,
			...
			{
				Config: tmpl.DeviceNamedBlockExt(t, instanceName, testRegion, rootPass),
				Check: resource.ComposeTestCheckFunc(
					checkExists(resName, nil),
					resource.TestCheckResourceAttr(resName, "label", "my-config"),
					devicesCheck,
